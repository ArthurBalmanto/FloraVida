...
<html>
	...
	<body>
		<div class="container card col-sm-8 shadow " 
			...
			<h2>Cadastro Cabeças/Face</h2>
			<form action="cadastro_cabeca.php" method="POST">
				<div class="container col-sm-8">
					<input class="form-control" 
					id="nomecabeca" 
					name="nome_cabeca" 
					type="text" 
					placeholder="Situação da Cabeça" 
			...
			<?php
				...
				$c_cabeca_ler = new C_Cabeca($db);
				$stmt = $c_cabeca_ler->ler();
					...
					while ($row_cabeca= $stmt->fetch(PDO::FETCH_ASSOC)){
						...
						echo "<tr>";
							...
							echo "<td>";
								...
								echo "<a href='atualiza_produto.php?id={$id_cab}' class='btn btn-default left-margin'>
									<span style=' color: green;'>
										<i class='fas fa-edit'></i>
									</spam>
								</a>";
								echo "<a delete-id='{$id_cab}' class='delete-object'>
									<span style=' color: green;'>
...
<?php	   
	if($_POST){
		...
		$c_cabeca = new C_Cabeca($db);

		$c_cabeca->nome_cab = $_POST['nome_cabeca'];
